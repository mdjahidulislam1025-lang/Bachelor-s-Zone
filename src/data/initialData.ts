...
export function getInitialMessData(): MessDatabaseState {
  const members = [
    {
      ...
      notes: 'স্থায়ী প্রধান এডমিন ও মেস পরিচালক (Primary Admin / Owner)',
    ...
    },
    {
      ...
      nickname: 'তানভীর',
      phone: '+8801614567890',
      email: 'tanvir.patwary@gmail.com',
      roomNo: '102',
      role: 'member' as const,
      status: 'active' as const,
      joiningDate: '2026-01-01',
  ...
  for (let day = 1; day <= 22; day++) {
    ...
    const cookMember = members[(day - 1) % members.length];
    const bazarMember = members[(day + 2) % members.length];
  ...
  const smsLogs = [
    {
      ...
      recipientId: 'm2',
      recipientName: 'Fiaaz Ajmaeen',
      phone: '+8801812345678',
      type: 'bazar_reminder' as const,
      message: 'আসসালামু আলাইকুম ফিয়াজ। ১৮ সেপ্টেম্বর আপনার মেসের বাজার দায়িত্ব। শুভকামনা - Bachelor Zone।',
  ...
  const notifications = [
    {
      ...
      message: 'ফিয়াজ আজকের বাজার সম্পন্ন করেছেন। মোট খরচ: ৳১,৮৫০।',
  ...
  const settings = {
    ...
    smsTemplates: {
      cookingReminder: 'আজ আপনার রান্নার দায়িত্ব। মেসের নির্ধারিত সময় অনুযায়ী রান্নার প্রস্তুতি নিন। মেনু: {menu} - Bachelor Zone',
      bazarReminder: 'আগামীকাল আপনার মেসের বাজার করার দায়িত্ব। প্রয়োজনীয় বাজার তালিকা Bachelor Zone অ্যাপে দেখে নিন।',
      monthEndStatement: '{month} মাসের মেস হিসাব প্রস্তুত হয়েছে। মোট মিল: {meals}, মোট খরচ: ৳{totalCost}, জমা: ৳{paid}, {balanceStatus}: ৳{balance}। বিস্তারিত হিসাব অ্যাপে দেখুন। - Bachelor Zone',
      paymentDueNotice: 'আপনার মেস বকেয়া ৳{dueAmount} টাকা জরুরি ভিত্তিতে পরিশোধ করার অনুরোধ করা হচ্ছে। - Bachelor Zone',
    },
    mealCutoffSettings: {
